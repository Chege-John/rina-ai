...
const Messenger = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-gray-50/50">
      {/* Header */}
      <div className="px-6 py-4 border-b bg-white flex items-center justify-between shrink-0 z-10 shadow-sm">
      ...
      {/* Messages */}
      <div className="flex-1 flex flex-col overflow-y-auto bg-[#fdfdfd] chat-window">
        <Loader loading={loading}>
          <div
            ref={messageWindowRef}
            className="w-full min-h-full flex flex-col gap-4 p-6"
          >
            {chats.length ? (
              chats.map((chat) => (
                <Bubble
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground opacity-50 min-h-[300px]">
      ...
      <div className="p-4 bg-white border-t shrink-0 z-10">
        ...
        >
          ...
          <Button
            type="submit"
            size="icon"
            className="rounded-xl bg-[#F97316] hover:bg-[#F97316] text-white h-10 w-10 shadow-md transition-transform active:scale-95"
            disabled={!chatRoom}
          >
